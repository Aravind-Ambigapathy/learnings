...
const tabs = [
    ...
    "Machining Quality & Process Control Practices",
];

const inspectionQulaity = [
    {
        title: "Dimensional Inspection",
        description: "CMM, height gauges, micrometers, bore gauges",
        icon: <img src='/images/icons/surface-preparation/container.svg' />,
    },
    {
        title: "Documentation",
        description: "Documentation- Inspection reports and material test certificates",
        icon: <img src='/images/icons/surface-preparation/container-1.svg' />,
    },
    {
        title: "Thread Inspection",
        description: "Go/No-Go gauges and thread gauges",
...
const machiningQuality = [
    {
        title: "Process planning and tooling optimization",
        // description: "CMM, height gauges, micrometers",
        // badge: "Precision",
        badgeColor: "bg-[#EEE7FC] text-[#5C3DBB]",
    },
    {
        title: "Fixture-based repeatability for batch production",
        // description: "Spectrometer, hardness testing, micro structure",
        // badge: "Lab",
        badgeColor: "bg-[#E8F4FC] text-[#2B6A94]",
    },
    {
        title: "In-process inspection and SPC monitoring",
        // description: "Dye penetrant (DPT), ultrasonic testing (UT), X-Ray",
        // badge: "NDT",
        badgeColor: "bg-[#FFF1E5] text-[#D97706]",
    },
    {
        title: "Raw material traceability and verification",
        // description: "Surface defect identification",
        // badge: "Visual",
        badgeColor: "bg-[#E7F8F1] text-[#15803D]",
    },
    {
        title: "Machine calibration and preventive maintenance",
        // description:"Melting temperature and chemical composition control",
        // badge: "In-Process",
        badgeColor: "bg-[#FCE7F3] text-[#BE185D]",
    },
    {
        title: "Final dimensional and visual quality checks",
        // description: "Inspection reports and material test certificates",
        // badge: "Reports",
        ...
        <section className="bg-white py-14">
            <div className="mx-auto max-w-7xl px-6">
                ...
                <h2 className="font-heading text-4xl font-semibold text-[#331C6F]">
                    Quality Inspection & Process Control in Machining
                </h2>

                <p className="mt-3 text-lg text-[#667085]">
                    Consistent Precision. Process Reliability. Enhanced performance.
                </p>
          ...
          "
                            >
                                <div className="flex items-center justify-between">
                                    <h3 className="font-heading font-semibold text-[#1D1B2E]">
                                        {item.title}
                                    </h3>
