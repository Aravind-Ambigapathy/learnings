      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-6">
        ...
        <div className="grid lg:grid-cols-[1.1fr_1fr] gap-12 mt-14">
          ...
          <div className="bg-white rounded-[24px] border border-[#E8E2F2] overflow-hidden shadow-sm">
            <div className="p-6 border-b border-[#ECE7F5]">
            ...
            <div className="p-6">
              ...
              <div className="mt-8">
                ...
                <label className="block cursor-pointer">
                  ...
                  <div className="mt-3 border-2 border-dashed border-[#D7CFF1] rounded-2xl px-6 py-12 text-center hover:bg-[#FAF8FF] transition">
          ...
          <div className="flex flex-col mt-4">
            {data.features.map((feature, index) => (
              <div
                key={feature.title}
                className={`pb-8 mb-8 border-b border-[#E5DFF0] last:border-b-0 last:pb-0 last:mb-0 transition-all duration-700 ${
                  isVisible
